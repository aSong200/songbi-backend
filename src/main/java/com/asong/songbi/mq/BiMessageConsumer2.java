...
@Slf4j
@Component
public class BiMessageConsumer2 {
...
//    @RabbitListener(queues = {BiMqConstant.BI_ALARM_QUEUE})
//    public void alarmQueue(String message, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag){
